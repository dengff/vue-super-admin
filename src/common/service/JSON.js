...
export const menuList = [
  {'icon': 'home-filled', 'title': '首页', 'path': '/home/index'},
  {
    ...
    'path': '/assembly',
    'children': [
      {'path': '/assembly/grid-layout', 'title': '布局组件', 'icon': 'menu'},
      {'path': '/assembly/search-panel', 'title': '搜索面板', 'icon': 'menu'},
      // {'path': '/assembly/selectFilter', 'title': '分类筛选器', 'icon': 'menu'},
      // {'path': '/assembly/svgIcon', 'title': 'SVG 图标', 'icon': 'menu'},
      // {'path': '/assembly/uploadImg', 'title': '图片上传', 'icon': 'menu'},
      // {'path': '/assembly/batchImport', 'title': '批量添加数据', 'icon': 'menu'},
      // {'path': '/assembly/wangEditor', 'title': '富文本编辑器', 'icon': 'menu'}
    ],
  },
